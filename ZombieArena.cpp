...
int main()
{
	...
	spriteAmmoIcon.setPosition(20, 700);
	...
	zombiesRemainingText.setPosition(1050, 700);
	...
	waveNumberText.setPosition(1050, 500);
	waveNumberText.setString("Wave: 0");

	// Health bar
	RectangleShape healthBar;
	healthBar.setFillColor(Color::Red);
	healthBar.setPosition(450, 700);
